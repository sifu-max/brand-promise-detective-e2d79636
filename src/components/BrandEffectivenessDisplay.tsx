...
import { TrendingUp, Award, Lock, ArrowRight, Eye, AlertTriangle } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/30 border border-border/50">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          <span className="font-medium">About AI-based scoring:</span> These scores are generated by an AI model and may vary slightly (±5 points) between analyses of the same content. 
          Factors such as page rendering differences, content extraction variability, and the inherent non-determinism of large language models can influence results. 
          Scores should be used as directional guidance rather than precise measurements. For a definitive brand audit, consult with a branding professional.
        </p>
      </div>
    </div>
  );
